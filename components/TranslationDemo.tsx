  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p>
          Currency: {formatNumber(499, { style: "currency", currency: "INR" })}
        </p>
      </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Example Component: Using T Component - DISABLED
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="max-w-md mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm mt-2">{t("auth.enter_phone")}</p>
      </div>
      ...
      <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
        <p className="text-xs text-amber-200">{t("auth.phishing_warning")}</p>
      </div>
    </div>
  );
}
